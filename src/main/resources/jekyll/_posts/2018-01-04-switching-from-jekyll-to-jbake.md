...
posts that have comments in [disqus](https://disqus.com/) because the uri is also an id. For this blog I am organizing
...
and yaml is the [Front Matter](https://jekyllrb.com/docs/frontmatter/). This gets the header text as a string:
...
the [repo](https://github.com/moaxcp/johnmercier.com). I followed
[this](https://help.github.com/articles/creating-a-personal-access-token-for-the-command-line/) guide to create a
